  ...
  return (
    <>
      ...
      <div className="value value-staked">
        {basePoolData && basePoolData.staked && basePoolData.staked.toFixed(2)}{" "}
        {pool.token.name}
      </div>
      <div className="value value-tokens">
        ...
        pool.poolType === PoolType.LP
          ? `${basePoolData.underlyingTokens.token1} / ${basePoolData.underlyingTokens.token2}`
          : basePoolData && basePoolData.staked}
      </div>
