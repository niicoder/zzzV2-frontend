...
function BoostingInfo() {
  return (
    <div className="boosting-info-content">
      ...
      <p>Currently, this multiplier is in effect for the following: </p>
      <p>
        1. Staking ZZZ in the Napper / Snore pool. <br />
        <br />
        2. ZZZ held in your wallet. <br />
        <br />
        3. Total amount of ZZZ redeemable from your ETH_ZZZ_UNI_LP Liquidity
        Pool on Uniswap.
      </p>
      <p>
        As a thank you for contributing to the ETH_ZZZ_UNI_LP Liquidity Pool,
        the ZZZs in these UNI tokens themselves will count as double (if you
        have 5 ZZZs in your UNI tokens, it will count as 10). More methods of
        holding and staking ZZZ will be added in the future.
      </p>
      <p>
        <b>NOTE</b>: <br /> Staked ETH_ZZZ_UNI_LP tokens <b>DO NOT</b> count
        towards your boost level.
      </p>
      <p>
      ...
      <p>
        ...
        to get bonuses on individual pools. Depending on the amount you spend it
        increases your bonus. This effect works exclusively on the pools you
        choose. It will <b>NOT</b> be transferred eg.from a version 1 pool to a
        version 2 eventhough the pools might share the same name.
      </p>
      <p>* Example 1</p>
      <p>
